...
def load_assets():
    try:
        ...
        le_area = joblib.load("le_area.joblib")
        le_location = joblib.load("le_location.joblib")
        le_property = joblib.load("le_property.joblib")
        area_scaler = joblib.load("area_scaler.joblib")
        bhk_scaler = joblib.load("bhk_scaler.joblib")
